...
export default function CardPress({ item }) {
  return (
    <div className="w-[80vw] h-full flex flex-col justify-between lg:flex-row lg:items-start lg:justify-start gap-6 border-r group-last:border-r-0 pr-8 lg:border-r-0 lg:pr-0 lg:border-b border-light-200 dark:border-dark-200">
